...
describe("parseMessageBody", () => {
  ...
  it("parses multiline body without links correctly", () => {
    ...
    expect(parseMessageBody(messageBody, false)).toStrictEqual([
      line1,
      "\n",
      line2,
      "\n",
  ...
  it("parses link with path", () => {
    const link =
      "http://www.google.com/root-path/page1#hashlink%20hello?arg1=123&arg2=321";
    const renderedResult = parseMessageBody(link, false);
    const renderedLink = renderedResult[1] as ReactElement;
  ...
  it("parses link with port and subdomains", () => {
    const link =
      "http://sub1.sub2.sub3.sub-4.google.com:8000/path-to-somewhere";
    const renderedResult = parseMessageBody(link, false);
    const renderedLink = renderedResult[1] as ReactElement;
